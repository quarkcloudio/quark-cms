...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('menus')->insert([
            ...
            ['id' =>24,'name' => '打印机管理','guard_name' => 'admin','icon' => '','type'=>'table','pid' => 21,'sort' => 0,'path' => 'admin/printer/index','show'  => 1,'status' => 1],
            ...
            ['id' =>'40','name' => '商家列表','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '39','sort' => '0','path' => 'admin/shop/index','show'  => '1','status' => '1'],
            ['id' =>'43','name' => '商家分类','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '39','sort' => '0','path' => 'admin/shopCategory/index','show'  => '1','status' => '1'],
            ...
            ['id' =>'48','name' => '商品分类','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '46','sort' => '0','path' => 'admin/goodsCategory/index','show'  => '1','status' => '1'],
            ['id' =>'49','name' => '品牌管理','guard_name' => 'admin','icon' => '','type'=>'default','pid' => '38','sort' => '0','path' => '/mall/goodsBrand','show'  => '1','status' => '1'],
            ['id' =>'50','name' => '品牌列表','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '49','sort' => '0','path' => 'admin/goodsBrand/index','show'  => '1','status' => '1'],
            ['id' =>'51','name' => '商品类型','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '46','sort' => '0','path' => 'admin/goodsType/index','show'  => '1','status' => '1'],
            ...
            ['id' =>'58','name' => '评价管理','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '52','sort' => '0','path' => 'admin/goodsComment/index','show'  => '1','status' => '1'],
            ['id' =>'59','name' => '商品单位','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '46','sort' => '0','path' => 'admin/goodsUnit/index','show'  => '1','status' => '1'],
            ['id' =>'60','name' => '详情版式','guard_name' => 'admin','icon' => '','type'=>'table','pid' => '46','sort' => '0','path' => 'admin/goodsLayout/index','show'  => '1','status' => '1'],
        ]);
    }
}
