...
namespace Modules\Portal\Http\Controllers\Home;
...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('portal::home/user/index',compact('user'));
    }
    ...
    public function profile(Request $request)
    {
        if($request->isMethod('post')) {
            ...
            $id = auth('web')->user()->id;
            $user = User::where('id',$id)->first();
            return view('portal::home/user/profile',compact('user'));
        }
    }
    ...
    public function safety(Request $request)
    {
        $id = auth('web')->user()->id;
        $user = User::where('id',$id)->first();
        return view('portal::home/user/safety',compact('user'));
    }
    ...
    public function updatePassword(Request $request)
    {
        if($request->isMethod('post')) {
            ...
            $id = auth('web')->user()->id;
            $user = User::where('id',$id)->first();
            return view('portal::home/user/password',compact('user'));
        }
    }
    ...
    public function email(Request $request)
    {
        if($request->isMethod('post')) {
            ...
            $id = auth('web')->user()->id;
            $user = User::where('id',$id)->first();
            return view('portal::home/user/email',compact('user'));
        }
    }
    ...
    public function changeEmail(Request $request)
    {
        ...
        return view('portal::home/user/changeEmail',compact('user','message'));
    }
    ...
    public function phone(Request $request)
    {
        if($request->isMethod('post')) {
            ...
            $id = auth('web')->user()->id;
            $user = User::where('id',$id)->first();
            return view('portal::home/user/phone',compact('user'));
        }
    }
}
