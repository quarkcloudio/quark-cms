<!-- 引入模板布局 -->
@extends('portal::home/layouts.app')
<!-- 定义标题 -->
@section('title', '用户中心')
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="/pc/user/profile" class="list-group-item list-group-item-action active">个人资料</a>
                    ...
                    <p class="card-text">
                        <form id="form">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" name="username" readonly class="form-control-plaintext" value="{{ $user->name }}">
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    ...
    $("#form").submit(function() {
        ...
        // ajax请求
        $.post("{{ route('pc/user/profile') }}",formData,function(result) {
