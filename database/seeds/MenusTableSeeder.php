...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('menus')->insert([
            ...
            ['id' => 19,'name' => '广告列表','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 18,'sort' => 0,'path' => 'admin/banner/index','show'  => 1,'status' => 1],
            ['id' => 20,'name' => '广告位列表','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 18,'sort' => 0,'path' => 'admin/bannerCategory/index','show'  => 1,'status' => 1],
            
            ['id' => 21,'name' => '应用插件','guard_name' => 'admin','icon' => 'icon-plugin','type'=>'default','pid' => 0,'sort' => 0,'path' => '/plugin','show'  => 1,'status' => 1],
            ['id' => 22,'name' => '评论管理','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 21,'sort' => 0,'path' => 'admin/comment/index','show'  => 1,'status' => 1],
            ['id' => 23,'name' => '友情链接','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 21,'sort' => 0,'path' => 'admin/link/index','show'  => 1,'status' => 1],

            ['id' => 29,'name' => '所有导航','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 25,'sort' => 0,'path' => 'admin/navigation/index','show'  => 1,'status' => 1],
            ['id' => 30,'name' => '分类列表','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 25,'sort' => 0,'path' => 'admin/category/index','show'  => 1,'status' => 1],
            ['id' => 31,'name' => '短信列表','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 25,'sort' => 0,'path' => 'admin/sms/index','show'  => 1,'status' => 1],
           
            ['id' => 61,'name' => '分类列表','guard_name' => 'admin','icon' => '','type'=>'engine','pid' => 3,'sort' => 0,'path' => 'admin/articleCategory/index','show'  => 1,'status' => 1],
        ]);
    }
}
